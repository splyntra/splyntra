...
export default function AgentDashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl p-6 lg:p-8">
      <Link href="/agents" className="mb-4 inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-900 dark:hover:text-white">
    ...
    <Card className="p-5">
      ...
      {runs.length === 0 ? (
        ...
        <ul className="-my-1 divide-y divide-gray-100 dark:divide-gray-800">
          {runs.map((r) => (
            <li key={r.id}>
              <Link href="/evaluations" className="flex items-center justify-between gap-3 py-2.5 text-sm hover:bg-gray-50 dark:hover:bg-gray-900/40">
                <div className="min-w-0">
    ...
    return (
      <Card>
        <EmptyState icon={Settings} title="This agent has no saved configuration">
          ...
          <div className="mt-3"><Link href="/agents/new" className="inline-flex items-center gap-1.5 rounded-lg bg-gray-900 px-3 py-1.5 text-sm font-medium text-white dark:bg-white dark:text-gray-900"><Plus className="h-4 w-4" /> Connect wizard</Link></div>
        </EmptyState>
      </Card>
    );
  }
  ...
  return (
    <Card className="p-5">
      <div className="mb-2 flex items-center justify-between">
        ...
        <Link href="/agents/new" className="text-xs text-splyntra-600 hover:underline">Reconfigure →</Link>
      </div>
