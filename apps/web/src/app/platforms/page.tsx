  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-8">
      <PageHeader
        ...
        action={
          <Link href="/platforms/connect" className="inline-flex items-center gap-1.5 rounded-lg bg-gray-900 px-4 py-2 text-sm font-medium text-white hover:bg-gray-800 dark:bg-white dark:text-gray-900">
