...
export default function ConnectPlatformPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-8">
      <Link href="/platforms" className="mb-4 inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-gray-900 dark:hover:text-white">
      ...
      <Card className="p-5">
        ...
        {stepId === "key" && platform && (
          <div className="space-y-4">
            ...
            <p className="text-[12px] text-gray-500">Already have a key? <Link href="/settings/keys" className="text-splyntra-600 hover:underline">Manage keys</Link>, then skip to the recipe.</p>
          </div>
        )}
